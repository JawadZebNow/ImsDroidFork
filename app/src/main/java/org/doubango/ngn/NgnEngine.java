...
public class NgnEngine {
    ...
    private static final String LIBS_FOLDER;
    ...
    static {
        DATA_FOLDER = String.format("/data/data/%s", NgnApplication.getContext().getPackageName());
        LIBS_FOLDER = String.format("%s/lib", DATA_FOLDER);
