...
import org.doubango.utils.NgnNetworkConnection;
import org.doubango.utils.NgnConfigurationEntry;
import org.doubango.utils.NgnObservableList;
...
//		= connectivityManager.startUsingNetworkFeature(ConnectivityManager.TYPE_MOBILE, "enableHIPRI");
    ...
    private boolean bindProcessToConnectionApi8(final NgnNetworkConnection connection) {
        ...
        try {
            ...
            boolean resultBool = (boolean) method.invoke(connectivityManager, ConnectivityManager.TYPE_MOBILE_HIPRI, hostAddressInt);
            return resultBool;
        } catch (Exception e) {
            //Do something
            return false;
